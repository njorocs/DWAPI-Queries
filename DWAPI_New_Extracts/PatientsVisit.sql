select ''                                                                               AS SatelliteName,
       ...
       (case fup.differentiated_care_group
       ...
       CASE fup.stability
           WHEN 1 THEN 'Yes'
           WHEN 2
               THEN 'No' END                                                            as EstablishmentAssessment,
       ...
       (case fup.condom_provided
            ...
            when 1175 then 'N/A' end)                                                   as ClientGivenCondoms,
       (case fup.substance_abuse_screening
            when 1065 then 'Yes'
            when 1066 then 'No'
            when 1067 then 'Unknown'
            when 1175
                then 'N/A' end)                                                         as ClientScreenedforSubstanceAbuse,
       (case fup.pwp_disclosure
            when 1065 then 'Yes'
            when 1066 then 'No'
            when 1067 then 'Unknown'
            when 1175 then 'N/A' end)                                                   as ClientDisclosedHIVStatus,
       (case fup.pwp_partner_tested
            when 1065 then 'Yes'
            when 1066 then 'No'
            when 1067 then 'Unknown'
            when 1175
                then 'N/A' end)                                                         as ClientsPartnerReceivedTesting,
       (case fup.cacx_screening
            when 703 then 'Positive'
            when 664 then 'Negative'
            when 1118 then 'Not Done'
            when 1175 then 'N/A' end)                                                   as ClientScreenedforCacx,
